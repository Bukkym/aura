...
- **M4.5 Live stretch moment.** The "Ora has learned this about you" beat on real data. Depends on M4.1 history + M4.2 narration. NOT built yet (the in-app Home/stretch surface is still the `/flow` sample-data showcase).
